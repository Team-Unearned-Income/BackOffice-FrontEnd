<template>
  ...
  >
    <q-card :class="size && `modal-size-${size}`" :style="dialogStyle">
      <q-card-section
      ...
      >
        ...
        <q-space />
        <q-btn v-close-popup dense flat icon="close" round @touchstart.stop @mousedown.stop />
      </q-card-section>

      <q-card-section class="no-scroll modal-content">
        <slot name="content" />
      </q-card-section>
      <q-separator />
