  ...
  >
    <template #filter-section>
      <div class="row justify-between" style="margin-bottom: 1rem">
        <div class="text-h6 text-bold">공연 예약 실패내역 조회</div>
      </div>
      <div class="form">
        <div class="row">
...
import {commonApi, operatingApi, showeventApi} from '@/service/api'
...
const onRequest = async (props) => {
  ...
  const tableRowResponse = await showeventApi
    .getShowEventFailedResvList({
